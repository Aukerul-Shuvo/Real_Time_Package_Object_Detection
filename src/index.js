...
const weights = "https://raw.githubusercontent.com/Aukerul-Shuvo/yolov5_Real_Time_Object_Detection/main/model.json";

const names = ['brand b product b1','brand b product b2','brand b product b3','asparagus','aubergine','beet','butter','cabbage','carrot','cucumber','eggs','garlic','ginger','leek','lemon','mushroom','onion','pepper','potato','tomato','zucchini','person','bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train', 'truck', 'boat', 'traffic light',
